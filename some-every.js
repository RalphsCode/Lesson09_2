...
function hasAZero(num) {
    const numbers = num.toString().split('');
        return numbers.some((numb) => {
            // look for the presence of a zero
            // if found: return true
            return numb.indexOf('0') !== -1;
        }
        )
}  // END hasAZero
...
function hasNoDuplicates(arr) {
    ...
    // Note to self: length only worls with arrays, use size with sets
